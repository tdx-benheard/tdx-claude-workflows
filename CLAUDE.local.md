...
**Type `wf` to load workflows** - Reads `.claude/CLAUDE-WORKFLOWS.md` which contains all trigger patterns and workflow file mappings.

When user requests build, commit, PR, tickets, or web testing, check CLAUDE-WORKFLOWS.md for the corresponding workflow file to read.
